...
## UK
    - [A pro-innovation approach to AI regulation](https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/1146542/a_pro-innovation_approach_to_AI_regulation.pdf)

## EU
    - [Behind EU lawmakers' challenge to rein in ChatGPT and generative AI](https://www.msn.com/en-gb/money/other/exclusive-behind-eu-lawmakers-challenge-to-rein-in-chatgpt-and-generative-ai/ar-AA1auB3A)
...
# Ethics
    ...
    - [How Will Language Modelers Like ChatGPT Affect Occupations and Industries?](https://arxiv.org/ftp/arxiv/papers/2303/2303.01157.pdf)
...
## Writing
    ...
    - [OpenAI's ChatGPT](chat.openai.com/chat)
    - [Notion](notion.ai)
    - [You.com](you.com)

## Images
     - [Bing Image Create](www.bing.com/create)
     - [OpenAI's Dall-E](labs.openai.com/)
     - [MidJourney](midjourney.com) (paywall?)
     - [Stable Diffusion](beta.dreamstudio.ai/dream)
     - [ControlNet Demo](huggingface.co/spaces/hysts/ControlNet)
